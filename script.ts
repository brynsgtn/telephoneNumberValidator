...
const resultsDiv = document.getElementById("results-div") as HTMLDivElement | null;
const modal = document.getElementById("myModal") as HTMLDivElement | null;
const btn = document.getElementById("modal-btn") as HTMLButtonElement | null;
...
const check = (): void => {
  ...
  const isValid: boolean = validFormat.some((valid: RegExp) => {
